...
<%-- 
    Document   : detail
    Created on : Nov 14, 2021, 1:38:01 AM
    Author     : Ducphi
--%>
                            ...
                            <div class="product-desc">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 text-center">
                                        <p class="addtocart"><a href="cart?id=${o.id}" class="btn btn-primary btn-addtocart"><i class="icon-shopping-cart"></i> Add to Cart</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
