        ...
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h2>Manage <b>Product</b><li class="active"><a href="home" style="color: white">Home</a></li></h2>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="clearfix">
                    ...
                    <ul class="pagination">
                        ...
                        <li class="page-item ${tag ==i?"active":""}"><a href="manager?index=${i}">${i}</a></li>
                        </c:forEach>
                    ...
                    <form action="add" method="post">
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label>CateID</label>
                                <textarea name="cateID" class="form-control" required></textarea>
                            </div>
                        </div>
